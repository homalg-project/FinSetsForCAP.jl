...
uninstall:
	julia -e 'using Pkg; Pkg.rm("FinSetsForCAP");'
...
git-commit:
	...
	echo -e "\033[32mCommitting changes in \"FinSetsForCAP\"\033[0m"; \
	git add .; \
	git commit \
		...
		echo -e "\033[33mNo changes in \"FinSetsForCAP\" to commit or no version bump detected.\033[0m"; \
	fi
