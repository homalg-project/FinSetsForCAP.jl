...
#! @Arguments object
@DeclareFilter( "IsSkeletalCategoryOfFiniteSets",
                  IsCapCategory );

#! @Description
#! The GAP category of objects in the skeletal category of finite sets.
#! @Arguments object
@DeclareFilter( "IsObjectInSkeletalCategoryOfFiniteSets",
                 IsCapCategoryObject );

#! @Description
#! The GAP category of morphisms in the skeletal category of finite sets.
#! @Arguments object
@DeclareFilter( "IsMorphismInSkeletalCategoryOfFiniteSets",
...
@BindGlobal( "IsCategoryOfSkeletalFinSets", IsSkeletalCategoryOfFiniteSets );
@BindGlobal( "IsSkeletalFiniteSet", IsObjectInSkeletalCategoryOfFiniteSets );
@BindGlobal( "IsSkeletalFiniteSetMap", IsMorphismInSkeletalCategoryOfFiniteSets );
@BindGlobal( "CategoryOfSkeletalFinSets", SkeletalCategoryOfFiniteSets );
