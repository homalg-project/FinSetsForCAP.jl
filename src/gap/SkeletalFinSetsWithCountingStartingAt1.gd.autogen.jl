...
#! @Arguments object
@DeclareFilter( "IsSkeletalCategoryOfFiniteSetsWithCountingStartingAt1",
                  IsCapCategory );

#! @Description
#! The GAP category of objects in the skeletal category of finite sets with counting starting at 1.
#! @Arguments object
@DeclareFilter( "IsObjectInSkeletalCategoryOfFiniteSetsWithCountingStartingAt1",
                 IsCapCategoryObject );

#! @Description
#! The GAP category of morphisms in the skeletal category of finite sets with counting starting at 1.
#! @Arguments object
@DeclareFilter( "IsMorphismInSkeletalCategoryOfFiniteSetsWithCountingStartingAt1",
