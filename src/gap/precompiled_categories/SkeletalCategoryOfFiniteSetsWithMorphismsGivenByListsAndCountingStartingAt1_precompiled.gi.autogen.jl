...
function ( cat_1, arg2_1, arg3_1 )
    ...
    if (Cardinality( Range( arg3_1 ) ) == 0 && @not Cardinality( Range( arg2_1 ) ) == 0)
        return false;
    else
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    return ForAll( CAP_JIT_EXPR_CASE_WRAPPER( function (  )
                if (100 * Length( deduped_3_1 ) < Length( deduped_4_1 ))
...
function ( cat_1, arg2_1 )
    ...
    return deduped_1_1 == 0 || @not Cardinality( Source( arg2_1 ) ) == 0 && SKELETAL_FIN_SETS_IsMonomorphism( List( AsList( arg2_1 ), function ( i_2 )
                  return -1 + i_2;
              end ), deduped_1_1 );
end
########
...
function ( cat_1, alpha_1 )
    ...
    return ForAll( deduped_2_1, function ( a_2 )
            ...
            end ) && Cardinality( Source( alpha_1 ) ) == Length( deduped_3_1 ) && ForAll( deduped_2_1, function ( a_2 )
...
function ( cat_1, arg2_1 )
    ...
    return IsBigInt( deduped_1_1 ) && deduped_1_1 >= 0;
end
########
