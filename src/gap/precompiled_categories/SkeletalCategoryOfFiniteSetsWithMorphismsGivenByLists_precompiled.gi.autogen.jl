...
########
function ( cat_1, arg2_1, arg3_1 )
    return Cardinality( arg2_1 ) == 0 || @not Cardinality( arg3_1 ) == 0;
end
########
...
function ( cat_1, arg2_1 )
    ...
    return deduped_1_1 == 0 || @not Cardinality( Source( arg2_1 ) ) == 0 && SKELETAL_FIN_SETS_IsMonomorphism( AsList( arg2_1 ), deduped_1_1 );
end
########
